...
// ============================================================================
// STATIC FILES — Serve the built frontend (Vite output in dist/)
// ============================================================================
...
// Catch-all: try static file first, then serve index.html (SPA fallback)
app.notFound((c) => {
  ...
  // This is what makes /entrar, /panel, etc. work
...
console.log(`[BRUTAL] Static files: ${existsSync(DIST_DIR) ? "found at " + DIST_DIR : "NOT FOUND (run npm run build)"}`);
