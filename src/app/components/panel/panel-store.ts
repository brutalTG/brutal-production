...
// ============================================================
// Uses localStorage as primary store, with optional KV sync.
// All IDs are UUIDs. Questions and Drops are independent entities.
// ============================================================

import type { Question, Drop, RevealArchetype, RevealScoringConfig, MultiplierCheckpoint, SplashConfig } from "../drop-types";
import { scheduleSyncToServer } from "./panel-sync";
...
function saveQuestions(questions: PanelQuestion[]) {
...
function saveDrops(drops: PanelDrop[]) {
