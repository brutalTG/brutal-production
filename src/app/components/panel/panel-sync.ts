...
function debugToast(msg: string, isError = false) {
  ...
  el.style.cssText = `
    font-family:'Fira Code',monospace;font-size:11px;padding:8px 12px;border-radius:8px;
    color:#fff;pointer-events:auto;word-break:break-all;
    background:${isError ? "#c0392b" : "#2d3436"};
